...
export function futureWaiverRows(data,league,outlook,prefs={}){
 ...
 return candidates.map(id=>({id,count:trending.get(id)||0,projection:model.totals[id],...model.evaluate(id)})).sort((a,b)=>moveRank(b)-moveRank(a)||b.count-a.count).slice(0,20);
}
