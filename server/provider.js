...
export function createProvider(store){
 ...
 return async(settings,{outlook=false,force=false}={})=>{
  ...
  const data={user:found.user,nfl:found.nfl,week,players,leagues:details,projections:{},games:{},schedules:{},trends:[],updatedAt:now,demo:false,errors,notes:[],sources};
