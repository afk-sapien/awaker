...
- **Waiver alerts use this week's projected starting points**, not the next-week or rest-of-season windows the waiver view also offers, and they do not know FAAB, waiver priority, or league-specific claim deadlines. Lineup opportunities appear in digests only. Background failures appear in the activity panel. Independent service-down notifications are not yet implemented.
